...
class ReportGenerator:
    ...
    def generate_markdown_report(
        ...
        lines.append(f"- Few Shot Reuse Rate: {metrics.memory.few_shot_reuse_rate:.2%}")
        lines.append(f"- Role Drift Rate: {metrics.memory.role_drift_rate:.2%}")
        lines.append(f"- Memory Cross Talk Rate: {metrics.memory.memory_cross_talk_rate:.2%}")
        ...
        lines.append(f"- Few Shot Reuse Rate: {behavior.few_shot_reuse_rate:.2%}")
        lines.append(f"- Role Drift Rate: {behavior.role_drift_rate:.2%}")
        lines.append(f"- Memory Cross Talk Rate: {behavior.memory_cross_talk_rate:.2%}")
