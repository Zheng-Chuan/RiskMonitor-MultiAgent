...
def _require_mysql_for_acceptance_tests():
    ...
    if not all([host, port, database, user, password]):
        raise RuntimeError("acceptance tests require MYSQL_HOST MYSQL_PORT MYSQL_DATABASE MYSQL_USER MYSQL_PASSWORD")
    ...
    try:
        ...
        raise RuntimeError("acceptance tests require reachable MySQL")
