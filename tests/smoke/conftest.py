...
def _require_mysql_for_smoke_tests():
    load_dotenv()
    ...
    if not all([host, port, database, user, password]):
        raise RuntimeError("smoke tests require MYSQL_HOST MYSQL_PORT MYSQL_DATABASE MYSQL_USER MYSQL_PASSWORD")
    ...
    try:
        ...
        raise RuntimeError("smoke tests require reachable MySQL")
