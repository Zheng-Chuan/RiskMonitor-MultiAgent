...
@pytest.mark.asyncio
async def test_week20_ask_json_falls_back_when_json_mode_is_unsupported(monkeypatch):
    monkeypatch.setenv("DISABLE_LLM", "0")
    monkeypatch.setenv("LLM_API_KEY", "test")
    monkeypatch.setenv("LLM_BASE_URL", "https://api.example.com/v1")
    monkeypatch.setenv("LLM_RATE_LIMIT_TOKENS_PER_MIN_DEFAULT", "1000000")
...
@pytest.mark.asyncio
async def test_week20_ask_json_returns_fallback_on_bad_json_output(monkeypatch):
    monkeypatch.setenv("DISABLE_LLM", "0")
    monkeypatch.setenv("LLM_API_KEY", "test")
    monkeypatch.setenv("LLM_BASE_URL", "https://api.example.com/v1")
    monkeypatch.setenv("LLM_RATE_LIMIT_TOKENS_PER_MIN_DEFAULT", "1000000")
