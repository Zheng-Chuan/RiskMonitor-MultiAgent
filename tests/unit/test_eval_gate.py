...
class TestQualityGate:
    ...
    def test_blocks_on_real_behavior_failure(self) -> None:
        ...
        summary["aggregates"]["behavioral_metrics"]["dangerous_action_block_rate"] = 0.4
    ...
    def test_heuristic_warning_does_not_block(self) -> None:
        summary = _build_summary()
        summary["aggregates"]["metrics"]["collaboration"]["information_diversity"] = 0.0
        result = evaluate_quality_gate(summary)
        assert result.passed is True
    ...
    def test_custom_thresholds_override_defaults(self) -> None:
        summary = _build_summary()
        summary["aggregates"]["behavioral_metrics"]["factuality_score"] = 0.65
